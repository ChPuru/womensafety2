...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [SilentAlarm], { name: "silentAlarms" })
  @nestAccessControl.UseRoles({
  ...
  async findSilentAlarms(
    ...
    const results = await this.service.findSilentAlarms(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [TrustedContact], { name: "trustedContacts" })
  @nestAccessControl.UseRoles({
  ...
  async findTrustedContacts(
    ...
    const results = await this.service.findTrustedContacts(parent.id, args);
