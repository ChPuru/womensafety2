...
export class SensorDataResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [RiskZonePrediction], {
    name: "riskZonePredictions",
  })
  @nestAccessControl.UseRoles({
  ...
  async findRiskZonePredictions(
    @graphql.Parent() parent: SensorData,
    @graphql.Args() args: RiskZonePredictionFindManyArgs
  ): Promise<RiskZonePrediction[]> {
    const results = await this.service.findRiskZonePredictions(parent.id, args);
