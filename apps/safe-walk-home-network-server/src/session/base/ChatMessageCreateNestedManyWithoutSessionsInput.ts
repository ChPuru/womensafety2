...
@InputType()
class ChatMessageCreateNestedManyWithoutSessionsInput {
...
export { ChatMessageCreateNestedManyWithoutSessionsInput as ChatMessageCreateNestedManyWithoutSessionsInput };
